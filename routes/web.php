...
Route::post('/user/password/store', [MainUserController::class, 'UserPasswordUpdate'])->name('password.update');

// All admin route 
Route::get('/admin/profile', [MainAdminController::class, 'AdminProfile'])->name('admin.profile');
Route::post('/admin/profile/store', [MainAdminController::class, 'AdminProfileStore'])->name('profile.store');
Route::get('/admin/password/view', [MainAdminController::class, 'AdminChangePassword'])->name('admin.change.password');
